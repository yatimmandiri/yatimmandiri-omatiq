...
export const programs: ProgramItem[] = [
    {
        ...
        category: "Al-Qur'an",
        description: "Cabang olimpiade untuk menguji pemahaman tajwid, ketepatan cara baca, dan kecintaan anak pada Al-Qur'an.",
    ...
    },
    {
        ...
        category: 'Matematika',
        description: 'Cabang olimpiade untuk mengasah logika, ketelitian, strategi berhitung, dan keberanian menyelesaikan soal.',
    ...
    },
    {
        ...
        slug: 'try-out-omatiq',
        category: 'Persiapan',
        description: 'Sesi persiapan untuk membantu peserta memahami format soal, ritme lomba, dan strategi menjelang olimpiade.',
...
export const news: NewsItem[] = [
    {
        ...
        category: 'Olimpiade',
        date: '10 Juni 2026',
        excerpt: "Ajang ini dirancang untuk mengasah kemampuan Al-Qur'an dan Matematika melalui pengalaman lomba yang menyenangkan dan tertata.",
    ...
    },
    {
        ...
        category: 'Insight',
        date: '4 Juni 2026',
        excerpt: 'Dua bidang ini membantu anak membangun akhlak, ketelitian, logika, dan percaya diri dalam proses belajar.',
    ...
    },
    {
        ...
        category: 'Impact',
        date: '28 Mei 2026',
        excerpt: 'OMATIQ membuka ruang bagi sekolah, guru, orang tua, dan komunitas untuk mendukung prestasi anak Indonesia.',
...
export const partners = ['Sekolah Mitra', 'TPQ Mitra', 'Komunitas Guru', 'Orang Tua', 'Mentor Daerah', 'Final Nasional'];

export const categories = ['All', "Al-Qur'an", 'Matematika', 'Persiapan', 'Nasional'];
