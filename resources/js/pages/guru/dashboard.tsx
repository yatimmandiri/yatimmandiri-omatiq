        ...
        <>
            ...
            <div className="flex flex-1 flex-col gap-6 p-4 lg:p-6">
                ...
                <div className="relative overflow-hidden rounded-[2rem] border bg-gradient-to-br from-[#17524A] via-[#0f3d36] to-[#12372f] p-6 text-white shadow-xl lg:p-8">
                    <div className="absolute -top-16 -right-16 size-64 rounded-full bg-[#E5BE1E]/15 blur-3xl" />
                    ...
                    <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-2 max-w-xl text-sm leading-6 text-white/70">
                                    ...
                                    selesaikan pendaftaran OMATIQ dalam satu
                                    tempat.
                                </p>
                        ...
                        <div className="flex shrink-0 flex-col gap-3 sm:flex-row lg:flex-col">
                            <Link
                                ...
                                prefetch
                                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#E5BE1E] px-5 py-3 text-sm font-black text-[#17524A] shadow-lg shadow-black/10 transition hover:translate-y-[-2px] hover:bg-[#d9b01c]"
                            >
                                Lengkapi Biodata{' '}
                                <ArrowRight className="size-4" />
                            </Link>
                            <Link
                                href="/admin/data-binaan"
                                prefetch
                            ...
                            >
                                <BookOpenCheck className="size-4" /> Kelola
                                Binaan
                            </Link>
                        </div>
                    </div>
                            ...
                            <div className="flex gap-5">
                                ...
                                <div>
                                    ...
                                    <div className="mt-3 h-1.5 w-full overflow-hidden rounded-full bg-zinc-100 dark:bg-zinc-800">
                                        <div
                                            className="h-full rounded-full bg-gradient-to-r from-[#17524A] to-[#E5BE1E] transition-all"
                                            style={{ width: `${percent}%` }}
                                        />
                                    </div>
                                </div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-1 max-w-xl text-sm leading-6 text-muted-foreground">
                                    Pilih binaan yang belum terdaftar, pilih
                                    kategori olimpiade, dan submit — status
                                    otomatis{' '}
