                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="mt-10 grid gap-6 lg:grid-cols-4">
                        {timeline.map((item, index) => (
                            <article
                                key={item.year}
                                className={`group overflow-hidden rounded-[32px] bg-[#F8FAFC] shadow-sm ring-1 ring-slate-100 transition duration-500 hover:-translate-y-2 hover:bg-white hover:shadow-2xl hover:shadow-[#0F60AC]/10 ${index % 2 === 1 ? 'lg:mt-10' : ''}`}
                            >
                                <div className="relative h-56 overflow-hidden">
                                    ...
                                    />
                                    <div className="absolute top-4 left-4 rounded-full bg-white/90 px-4 py-2 text-sm font-black text-[#F15F23] backdrop-blur">
                                        {item.year}
                                    </div>
                                </div>
                                <div className="p-6">
                                    <span className="inline-flex items-center gap-2 rounded-full bg-[#0F60AC]/10 px-3 py-1 text-xs font-black tracking-wide text-[#0F60AC] uppercase">
                                        <MapPin className="h-3.5 w-3.5" />
                                        {item.theme}
                                    </span>
                                    <h3 className="mt-4 text-xl leading-tight font-black text-[#1E293B]">
                                        {item.title}
                                    </h3>
                                    <p className="mt-3 text-sm leading-7 text-[#64748B]">
                                        {item.text}
