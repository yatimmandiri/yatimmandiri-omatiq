...
class UpdateTeacherParticipantRequest extends FormRequest
{
    ...
    {
        return [
            'nik' => ['required', 'string', 'size:16', Rule::unique('students', 'nik')->ignore($this->route('participant')?->student_id)],
